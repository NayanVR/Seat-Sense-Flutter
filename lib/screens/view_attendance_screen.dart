...
//                             final success = await _attendanceService.manualMarkAttendance(
//                               context: context,
//                               email: email,
//                               eventId: _selectedEvent!.id,
//                             );
...
//                   final eventName = _events.firstWhere((e) => e.id == value).name;
...
//                     final record = _attendanceRecords[rowIndex];
//                     final formattedTime = record['time'] != null
//                         ? DateFormat.Hms().format(DateTime.parse(record['time']).toLocal())
//                         : '';
//                     final enrollmentNumber = record['email']?.split('@').first ?? '';

//                     return Dismissible(
//                       key: Key(record['id'] ?? record['email'] ?? rowIndex.toString()),
...
//                     return Dismissible(
//                       key: Key(record['id'] ?? record['email'] ?? index.toString()),
//                       direction: DismissDirection.endToStart,
//                       background: Container(
//                         alignment: Alignment.centerRight,
//                         padding: const EdgeInsets.symmetric(horizontal: 20),
...
//                           title: Text('${record['first_name']} ${record['last_name']}', style: theme.textTheme.small),
//                           description: Text('Enrollment: $enrollmentNumber\nTime: $formattedTime'),
                    ...
                    return Padding(
                      ...
                      child: Dismissible(
                        ...
                        background: ClipRRect(
                          borderRadius: BorderRadius.circular(12), // Same rounding as the container
                          child: Container(
                            alignment: Alignment.centerRight,
                            padding: const EdgeInsets.symmetric(horizontal: 20),
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(12), // rounded border for container
                          child: Container(
